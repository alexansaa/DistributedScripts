...
CREATE TABLE producto_central (Id NUMBER(20,0) NOT NULL,
                            Costo NUMBER(8,3) NOT NULL,
                            Descripcion VARCHAR2(250),
                            Marca VARCHAR2(20) NOT NULL,
                            Modelo VARCHAR2(30) NOT NULL);
ALTER TABLE producto_central ADD CONSTRAINT producto_central_pk PRIMARY KEY(Id);
CREATE MATERIALIZED VIEW LOG ON producto_central;
...
ALTER TABLE facilita ADD CONSTRAINT facilita_fk_prod FOREIGN KEY (Id_Producto) REFERENCES producto_central (Id);
...
INSERT INTO producto_central VALUES (12345678901234567890,250.501,'Kit embrague Toyota Hilux 2007 4x4','Japan Repuestos','mx375');
INSERT INTO producto_central VALUES (12345678901233367890,50.50,'Kit frenos Honda Civic 2011','Korean Repuestos','mx300');
INSERT INTO producto_central VALUES (12345678901777777890,150.80,'Retrovisor Derecho Nissan Centra','Indian Repuestos','mx655');
INSERT INTO producto_central VALUES (12311118901234567890,25.05,'Agua destilada nacional','Patito','ec777');
